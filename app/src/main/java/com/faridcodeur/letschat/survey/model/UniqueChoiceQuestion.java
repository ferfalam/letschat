...
public class UniqueChoiceQuestion {
    ...
    public UniqueChoiceQuestion(AppCompatActivity appCompatActivity, Context context, LinearLayout linearLayout) {
        view = appCompatActivity.getLayoutInflater().inflate(R.layout.new_survey_unique_choice_item, null);
        question = view.findViewById(R.id.question);
        newRadioTextInput = view.findViewById(R.id.new_radio_text_input);
